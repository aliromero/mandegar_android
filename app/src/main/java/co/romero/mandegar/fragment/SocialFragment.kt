...
import co.romero.mandegar.MyDividerItemDecoration
...
class SocialFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return when (index) {
            KEY_PAGER -> {
                view = inflater.inflate(R.layout.pager_social, container, false)
                pager(view)
                view
            }
            "1" -> {
            ...
            "postImage" -> {
                view = inflater.inflate(R.layout.fragment_social_post_image, container, false)
                showImagePost(view,postId!!)
                view
            }
            "notification" -> {
    ...
    private fun pager(view: View) {
        ...
        pagerAdapter.addFragment(SocialFragment.newInstance("3"), BEST_OF)
        pagerAdapter.addFragment(SocialFragment.newInstance("1"),   TOP_GALLERY)
...
//        }
    ...
    companion object {
        ...
        fun newInstance(index: String, tab: Int = 0,postId: Int = 0): SocialFragment {
