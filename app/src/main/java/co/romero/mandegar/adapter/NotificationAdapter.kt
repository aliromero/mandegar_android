...
class NotificationAdapter(private val mContext: Context?, private val items: List<String>) : RecyclerView.Adapter<NotificationAdapter.CustomViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): CustomViewHolder {
        val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.item_notification, null)
